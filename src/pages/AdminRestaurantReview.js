...
// API Configuration
const API_ROOT = "http://192.168.2.21:5000/api";
                                        ...
                                        <tr key={r.restaurant_id}>
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    onClick={async () => {
                                                    await fetch("http://192.168.2.21:5000/api/v1/admin/restaurants/send-excel-template", {
                                                        method: "POST",
                                                        headers: {
                                                        Authorization: `Bearer ${ADMIN_TOKEN}`,
                                                ...
                                                {/* <button
                                                    ...
                                                    onClick={async () => {
                                                        ...
                                                        const res = await fetch(
                                                            "http://192.168.2.21:5000/api/v1/admin/restaurants/send-remaining-profile-mail",
                                                            {
                                                            method: "POST",
                                                            headers: {
                                                                Authorization: `Bearer ${ADMIN_TOKEN}`,
