                            ...
                            <button
                              ...
                              onClick={async () => {
                                try {
                                  ...
                                  alert(
                                    "Server error while sending Excel template.",
                                  );
                                }
                              }}
                            >
                          ...
                          <td>
                            <div className="table-actions">
                              <button
                                ...
                                disabled={
                                  isSupportAdmin && !r.assigned_admin_id
                                }
                              ...
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/profile/restaurant/${r.restaurant_id}`,
                                  )
                                }
                              >
                                Profile
