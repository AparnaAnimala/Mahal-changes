...
const getFlag = (country) => {
 ...
 useEffect(() => {
              ...
              {filteredProducts
                ...
                .map((p, i) => (
                  <div className="col-xl-2 col-sm-6" key={`{p.id}-${i}`}>
                    ...
                    alt={p.name}
                    onError={(e) => {
                      console.log("Image failed:", p.image || p.img1);
                  ...
                  />
                       ...
                       {offersMap[p.product_id || p.id] && (() => {
                        ...
                        {(() => {
                          ...
                          if (t.includes("flat")) {
                            return `QR ${offer.flat_amount} OFF`;
                          }
  ...
  <h4 className="product_title">{p.name}<div className="unit_badge">
